//
//  SearchResultsCollectionManager.swift
//  Deals Bazaar
//
...
class SearchResultsCollectionManager: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
    
    weak var collectionView: UICollectionView?
    var viewModel:PSearchResultsViewModel?
    
    init(withCollectionView:UICollectionView, andViewModel: PSearchResultsViewModel){
