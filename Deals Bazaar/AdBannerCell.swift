...
class AdBannerCell:UICollectionViewCell, GADNativeExpressAdViewDelegate{

    
    var item:AdBannerRow?{
        didSet{
    ...
    func setupViews(){
        ...
        nativeAdView.frame = CGRect(x:5, y:5, width:self.frame.width - 10, height: 90)
    }
